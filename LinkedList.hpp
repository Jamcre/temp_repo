...
Description: This file contains the interface of the 'LinkedList' template class.
*/
...
public:
    ...
    */
    LinkedList(const LinkedList<ItemType> &another_LinkedList);
    ...
    */
    void reverseCopy(const LinkedList<ItemType> &another_LinkedList);
